...
const Navbar = () => {
  ...
  return (
    <>
      <div className="md:hidden flex justify-between items-center bg-white px-4 py-3 shadow fixed w-full z-50">
      ...
      <nav
        className={`${
          isOpen ? 'block' : 'hidden'
        } md:block fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-40 transition-all duration-300 ease-in-out`}
      >
        ...
        <div>
          ...
          <ul>
            <li className="pl-6 py-3 hover:bg-blue-500 transition-colors">
              <Link
                to="/"
                className="flex items-center text-gray-700 hover:text-white w-full"
              >
