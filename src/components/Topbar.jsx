...
const Topbar = () => {
  return (
    ...
    <div className="md:fixed  top-0 left-64 right-0 z-20  bg-gray-300/40 backdrop-blur-lg shadow h-16 flex items-center px-6 justify-between lg:pl-15 lg:pr-15">
